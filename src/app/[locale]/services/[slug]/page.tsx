...
const services = [
  { id: 'immigration', key: 'immigration', icon: 'Globe', areaKeys: ['expressEntry', 'pnp', 'business', 'categoryBased', 'familySponsorship', 'humanitarian', 'workPermits', 'studyPermits', 'visitorVisas', 'citizenship'] },
